...
// 7.- Crear variable booleanoMix0 cuyo valor sea la compración booleana (booleano1 or booleano2) and
// (booleano1 or (not booleano1 and not booleano2)
...
// 10.- Crear variable contarHasta10_2 con valor 0 e incrementar su valor con un bucle for hasta que
// se verifique que contarHasta10_2 === 10
...
// 11.- Crear las variables postI y postJ con valor 0 a continuación cree un
// bucle que itere 11 veces. En cada iteración se deberá sumar al valor de postI el valor de postJ++
var postI = 0;
var postJ = 0;
for(let i = 0; i < 11; i++) {
    postJ++;
...
// 12.- Crear la variable sumaPares con valor 0 a continuación crea un bucle que itere
// 10 veces (i < 10) si la iteración es par se deberá sumar a sumaPares el número de la iteración actual (i)
var sumaPares = 0;
for(let i = 0; i < 10; i++) {
    if(i % 2 == 0) {
        sumaPares += i;
